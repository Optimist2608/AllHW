<?php
// Можно еще и массив с пользователями было сделать и в него вложить посты данного человека, но тут нет смысла
// eсть вопрос лучше данные объектами делать в данном случае или объектом?
const DATA_POSTS = [
    [
        "previewPhoto" => [
        ...
        <div class="container">
            ...
            <div class="row blog-entries">
                <div class="col-md-12 col-lg-8 main-content">
                    <div class="row">
                        <?php
                        foreach (DATA_POSTS as $key => $postInfo): ?>
                            <div class="col-md-6">
                                <a href="blog-single.html" class="blog-entry element-animate"
                                   data-animate-effect="fadeIn">
                                    <img src="<?= $postInfo["previewPhoto"]["src"] ?>" alt="Image placeholder">
                                    <div class="blog-content-body">
                                        <div class="post-meta">
                                            <span class="author mr-2"><img src="<?= $postInfo["autor"]["src"] ?>"
                                                   alt="<?= $postInfo["autor"]["name"] ?>"> <?= $postInfo["autor"]["name"] ?></span>&bullet;
                                            <span class="mr-2"><?= $postInfo["date"] ?> </span> &bullet;
                                            <span class="ml-2"><span
                                                        class="fa fa-comments"></span> <?= $postInfo["countComments"] ?></span>
                                        </div>
